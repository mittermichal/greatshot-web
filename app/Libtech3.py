...
class MethodOfDamage(Enum):
    ...
    MOD_STEN = auto()
    MOD_GARAND = auto()
    MOD_SNOOPERSCOPE = auto()
    MOD_SILENCER = auto()
    MOD_FG42 = auto()
    MOD_FG42SCOPE = auto()
    MOD_PANZERFAUST = auto()
    MOD_GRENADE_LAUNCHER = auto()
    MOD_FLAMETHROWER = auto()
    MOD_GRENADE_PINEAPPLE = auto()
    MOD_CROSS = auto()
    MOD_MAPMORTAR = auto()
    MOD_MAPMORTAR_SPLASH = auto()
    MOD_KICKED = auto()
    MOD_GRABBER = auto()
    MOD_DYNAMITE = auto()
    MOD_AIRSTRIKE = auto()
    ...
    MOD_FALLING = auto()
    MOD_SUICIDE = auto()
    MOD_TARGET_LASER = auto()
    MOD_TRIGGER_HURT = auto()
    MOD_EXPLOSIVE = auto()
    MOD_CARBINE = auto()
    MOD_KAR98 = auto()
    MOD_GPG40 = auto()
    ...
    MOD_TRIPMINE = auto()
    MOD_SMOKEBOMB = auto()
    MOD_MOBILE_MG42 = auto()
    MOD_SILENCED_COLT = auto()
    MOD_GARAND_SCOPE = auto()
    MOD_CRUSH_CONSTRUCTION = auto()
    MOD_CRUSH_CONSTRUCTIONDEATH = auto()
    MOD_CRUSH_CONSTRUCTIONDEATH_NOATTACKER = auto()
    MOD_K43 = auto()
    MOD_K43_SCOPE = auto()
    MOD_MORTAR = auto()
    MOD_AKIMBO_COLT = auto()
    MOD_AKIMBO_LUGER = auto()
    MOD_AKIMBO_SILENCEDCOLT = auto()
    MOD_AKIMBO_SILENCEDLUGER = auto()
    MOD_SMOKEGRENADE = auto()
    MOD_SWAP_PLACES = auto()
    MOD_SWITCHTEAM = auto()
